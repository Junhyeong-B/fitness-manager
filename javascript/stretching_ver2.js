// 아래 쪽 Button Click 시 해당 버튼에 해당하는 이미지 표시
...
next.addEventListener("click", () => {
    if (slides[0].classList.contains("showing1")) {
        for (let x of slides) {
            x.classList.remove("showing1");
            x.classList.remove("showing3");
            x.classList.add("showing2");
    ...
    else if (slides[0].classList.contains("showing2")) {
        for (let x of slides) {
            x.classList.remove("showing1");
            x.classList.remove("showing2");
            x.classList.add("showing3");
    ...
    else if (slides[0].classList.contains("showing3")) {
        for (let x of slides) {
            x.classList.remove("showing2");
            x.classList.remove("showing3");
            x.classList.add("showing1");
